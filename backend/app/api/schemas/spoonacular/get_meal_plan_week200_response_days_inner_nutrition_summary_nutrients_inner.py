...
class GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner(BaseModel):
    """
    ...
    percent_daily_needs: Union[StrictFloat, StrictInt] = Field(alias="percentDailyNeeds")
    __properties: ClassVar[List[str]] = ["name", "amount", "unit", "percentDailyNeeds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unit": obj.get("unit"),
            "percentDailyNeeds": obj.get("percentDailyNeeds")
        })
        return _obj
