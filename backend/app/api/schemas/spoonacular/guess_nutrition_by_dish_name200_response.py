...
class GuessNutritionByDishName200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "calories": GuessNutritionByDishName200ResponseCalories.from_dict(obj["calories"]) if obj.get("calories") is not None else None,
            "carbs": GuessNutritionByDishName200ResponseCalories.from_dict(obj["carbs"]) if obj.get("carbs") is not None else None,
            "fat": GuessNutritionByDishName200ResponseCalories.from_dict(obj["fat"]) if obj.get("fat") is not None else None,
            "protein": GuessNutritionByDishName200ResponseCalories.from_dict(obj["protein"]) if obj.get("protein") is not None else None,
