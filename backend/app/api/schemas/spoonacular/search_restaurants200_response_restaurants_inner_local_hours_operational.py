...
class SearchRestaurants200ResponseRestaurantsInnerLocalHoursOperational(BaseModel):
    ...
    """ # noqa: E501
    monday: Optional[StrictStr] = Field(default=None, alias="Monday")
    tuesday: Optional[StrictStr] = Field(default=None, alias="Tuesday")
    wednesday: Optional[StrictStr] = Field(default=None, alias="Wednesday")
    thursday: Optional[StrictStr] = Field(default=None, alias="Thursday")
    friday: Optional[StrictStr] = Field(default=None, alias="Friday")
    saturday: Optional[StrictStr] = Field(default=None, alias="Saturday")
    sunday: Optional[StrictStr] = Field(default=None, alias="Sunday")
