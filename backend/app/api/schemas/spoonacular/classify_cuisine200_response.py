...
class ClassifyCuisine200Response(BaseModel):
    """
    
    """ # noqa: E501
    cuisine: Annotated[str, Field(min_length=1, strict=True)]
    cuisines: List[StrictStr]
    confidence: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["cuisine", "cuisines", "confidence"]
