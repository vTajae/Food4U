...
class GetWineRecommendation200ResponseRecommendedWinesInner(BaseModel):
    """
    ...
    rating_count: StrictInt = Field(alias="ratingCount")
    score: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["id", "title", "averageRating", "description", "imageUrl", "link", "price", "ratingCount", "score"]
