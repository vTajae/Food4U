...
class ImageAnalysisByURL200ResponseNutritionCalories(BaseModel):
    """
    ...
    confidence_range95_percent: ImageAnalysisByURL200ResponseNutritionCaloriesConfidenceRange95Percent = Field(alias="confidenceRange95Percent")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "unit": obj.get("unit"),
            "confidenceRange95Percent": ImageAnalysisByURL200ResponseNutritionCaloriesConfidenceRange95Percent.from_dict(obj["confidenceRange95Percent"]) if obj.get("confidenceRange95Percent") is not None else None,
