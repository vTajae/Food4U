...
class RecipeInformationWinePairingProductMatchesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "description", "price", "imageUrl", "averageRating", "ratingCount", "score", "link"]
