...
class GetConversationSuggests200ResponseSuggests(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_": [GetConversationSuggests200ResponseSuggestsInner.from_dict(_item) for _item in obj["_"]] if obj.get("_") is not None else None
        })
        return _obj
