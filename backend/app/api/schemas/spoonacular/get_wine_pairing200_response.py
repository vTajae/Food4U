...
class GetWinePairing200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productMatches": [GetWinePairing200ResponseProductMatchesInner.from_dict(_item) for _item in obj["productMatches"]] if obj.get("productMatches") is not None else None
        })
        return _obj
