...
class MapIngredientsToGroceryProducts200ResponseInner(BaseModel):
    """
    ...
    ingredient_image: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="ingredientImage")
    meta: List[StrictStr]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ingredientImage": obj.get("ingredientImage"),
            "meta": obj.get("meta"),
            "products": [MapIngredientsToGroceryProducts200ResponseInnerProductsInner.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
