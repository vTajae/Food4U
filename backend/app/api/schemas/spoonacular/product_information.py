...
class ProductInformation(BaseModel):
    ...
    usda_code: Optional[StrictStr] = Field(default=None, alias="usdaCode")
    ...
    ingredients: Annotated[List[IngredientBasics], Field(min_length=0)]
    likes: Union[StrictFloat, StrictInt]
    aisle: Optional[StrictStr]
    credits: Optional[ProductInformationCredits] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "upc", "usdaCode", "breadcrumbs", "imageType", "badges", "importantBadges", "ingredientCount", "generatedText", "ingredientList", "ingredients", "likes", "aisle", "credits", "nutrition", "price", "servings", "spoonacularScore"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if usda_code (nullable) is None
        # and model_fields_set contains the field
        if self.usda_code is None and "usda_code" in self.model_fields_set:
            _dict['usdaCode'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "likes": obj.get("likes"),
            "aisle": obj.get("aisle"),
            "credits": ProductInformationCredits.from_dict(obj["credits"]) if obj.get("credits") is not None else None,
