...
class MapIngredientsToGroceryProducts200ResponseInnerProductsInner(BaseModel):
    """
    MapIngredientsToGroceryProducts200ResponseInnerProductsInner
    """ # noqa: E501
    id: StrictInt
    title: Annotated[str, Field(min_length=1, strict=True)]
    upc: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["id", "title", "upc"]
